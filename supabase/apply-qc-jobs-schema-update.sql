-- =====================================================
-- Apply QC Jobs Schema Update
-- Run this in Supabase SQL Editor
-- This adds the missing columns for the queue-based QC system
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_qc_jobs_file_name ON qc_jobs(file_name) WHERE file_name IS NOT NULL;
...
COMMENT ON COLUMN qc_jobs.file_name IS 'Original filename for display purposes';
